...
export default function AIMessage({ message }: Props) {
  return (
    <div className='w-full text-token-text-primary' data-testid='conversation-turn-3'>
      <div className='px-4 py-2 justify-center text-base md:gap-6 m-auto'>
        <div className='flex flex-1 text-base mx-auto gap-3 md:px-5 lg:px-1 xl:px-5 md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem] group final-completion'>
          ...
          <div className='relative flex w-full flex-col agent-turn'>
            <div className='font-semibold select-none'>TheoBot</div>
            <div className='flex-col gap-1 md:gap-3'>
              <div className='flex flex-grow flex-col max-w-full'>
                <div
                  data-message-author-role='assistant'
                  data-message-id='e03f9d12-fb93-49ed-97bd-f46df4f780e8'
